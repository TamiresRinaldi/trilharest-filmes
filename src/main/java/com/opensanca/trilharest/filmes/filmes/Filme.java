...
public class Filme {
	...
	public boolean emExibicao(LocalDate dataReferencia) {
		...
		boolean referenciaMaiorIgualInicio = ( getInicioExibicao().isEqual(dataReferencia) || getInicioExibicao().isBefore(dataReferencia) );
		boolean referenciaMenorIgualFim = ( getFimExibicao().isEqual(dataReferencia) || getFimExibicao().isAfter(dataReferencia) );
		return referenciaMaiorIgualInicio && referenciaMenorIgualFim;
	}
